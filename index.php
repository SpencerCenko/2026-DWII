...
// CATÁLOGO DE AULAS
// Arrau associativo: cada aula é um bloco [...] com suas chaves.
...
[
    ...
    "descricao" => "Página estática com HTML e CSS - foto de perfil e
    layout responsivo.",
...
[
    ...
    "descricao" => "Mini-site de portfólio com variáveis, includes e menu dinãmico.",
...
<!-- 
    ...
    (sem "../") -- sem nenhum CSS embutido aqui.
...
<div class="container">
    <!-- INSTRUÇÕES DE USO -- exibida logo ao abrir o repositório -->
     <div class="box-info" style="margin-top: 0;">
        <h3> Como executar este repositório</h3>
        <p style="font-size: 14px; color: #374151;">
            Suba o servidor PHP na <strong>raiz</strong> para
...
<p style="font-size: 13px; color: #6b7280; margin-top: 8px;">
    Esta página é o hub de navegação. Use os botões abaixo para acessar cada 
    projeto.
</p>
</div>
...
<!-- LISTAGEM DAS AULAS -- foreach percorre o array $aulas -->
 ...
 <h2 class="secao" >
         Projetos por Aula</h2>
        <?php foreach ($aulas as $aula): ?>
            <main>
        <!-- 
            border-left-color dinâmica: cada tem sua cor definida no array.
            ...
            <p><?php echo htmlspecialchars($aula['nome']); ?></p>
        </h3>
        <p><?php echo htmlspecialchars($aula['descricao']); ?></p>
        <span class="conceitos">
            <?php echo htmlspecialchars($aula['conceitos']); ?></p>
        </span><br>
