...
// Um inteiro positivo com 999 pode não existir na tabela.
        ...
        <!-- Mensagem de erro de validação -->
         ...
         <!-- FOrmulário de edição
          ...
          <form action="editar.php?id=<?php echo $id; ?>" method="post" class="formulario">
            ...
            <!-- value preenchido com dadosatuais do banco(ou digitados,
            se houve algum erro) -->
            <input type="text" name="nome" class="input-texto" value="
...
<?php echo htmlspecialchars($projeto['descricao']); ?></textarea>
            ...
            <div class="campo">
                ...
                <input type="text" name="tecnologias" class="input-texto" value="
<?php echo htmlspecialchars($projeto['tecnologias']); ?>">
            </div>

                <div class="campo">
                <label class="label-campo">Link Github(opcional) *</label>
                <input type="url" name="link_github" class="input-texto" value="
<?php echo htmlspecialchars($projeto['link_github'] ?? ''); ?>">
            </div>

                <div class="campo">
                <label class="label-campo">Ano *</label>
                <input type="text" name="ano" class="input-texto" value="
<?php echo (int) $projeto['ano']; ?>" min="2000" max="2099">
            </div>
